...
export default function CamerasView() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-center gap-6 p-6">
      ...
      >
        {/* MJPEG stream - plain <img> required; next/image does not support streaming sources */}
      ...
      <p className="text-zinc-500 text-sm">
        Alerts triggered: <span className="font-mono text-white">{alertCount}</span>
      </p>
      ...
      <p className="text-xs text-zinc-600 max-w-sm text-center">
        ...
        alert. Set <code className="bg-zinc-800 px-1 rounded">RTSP_URL</code> on the
